...
function IrriterenPanel(props: { server: IServer; player: IPlayer | null }) {
  ...
  function sendActions() {
    ...
    if (sudoMessage !== "") actionJSON.SudoCommand = sudoMessage;
  ...
  function selectAction(actionString: string) {
    ...
    else setActions((actions: any) => [...actions, actionString]);
  }
  ...
  return (
    <>
      ...
      <div className="annoy-container">
        ...
        {sudoModalOpen && (
          <SudoModal onAccept={handleSetCommand} onCancel={handleModalClose} />
        )}
      </div>
    </>
  );
