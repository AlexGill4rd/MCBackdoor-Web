...
function EnderchestPane(props: {player: any, Server:any, itemList: any[], inventoryAction: any;}){
    const [enderchestItems, setEnderchestItems] = useState<any>([]);
    useEffect(() => {
        function loadInventories(){
            socket.emit("feature:player", socket.id, props.Server.Servername, props.player.UUID, "inventory", {Type: "get-enderchest"});
        }
